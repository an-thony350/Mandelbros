...
proc update_PARAM_VALUE.PALETTE_SCALE_FRAC { PARAM_VALUE.PALETTE_SCALE_FRAC } {
	# Procedure called to update PALETTE_SCALE_FRAC when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.PALETTE_SCALE_FRAC { PARAM_VALUE.PALETTE_SCALE_FRAC } {
	# Procedure called to validate PALETTE_SCALE_FRAC
	return true
}

proc update_PARAM_VALUE.PALETTE_SCALE_W { PARAM_VALUE.PALETTE_SCALE_W } {
	# Procedure called to update PALETTE_SCALE_W when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.PALETTE_SCALE_W { PARAM_VALUE.PALETTE_SCALE_W } {
	# Procedure called to validate PALETTE_SCALE_W
	return true
}

proc update_PARAM_VALUE.PALETTE_SEL_BITS { PARAM_VALUE.PALETTE_SEL_BITS } {
	# Procedure called to update PALETTE_SEL_BITS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.PALETTE_SEL_BITS { PARAM_VALUE.PALETTE_SEL_BITS } {
	# Procedure called to validate PALETTE_SEL_BITS
	return true
}
...
proc update_MODELPARAM_VALUE.PALETTE_SCALE_W { MODELPARAM_VALUE.PALETTE_SCALE_W PARAM_VALUE.PALETTE_SCALE_W } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.PALETTE_SCALE_W}] ${MODELPARAM_VALUE.PALETTE_SCALE_W}
}

proc update_MODELPARAM_VALUE.PALETTE_SCALE_FRAC { MODELPARAM_VALUE.PALETTE_SCALE_FRAC PARAM_VALUE.PALETTE_SCALE_FRAC } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.PALETTE_SCALE_FRAC}] ${MODELPARAM_VALUE.PALETTE_SCALE_FRAC}
}

proc update_MODELPARAM_VALUE.PALETTE_SEL_BITS { MODELPARAM_VALUE.PALETTE_SEL_BITS PARAM_VALUE.PALETTE_SEL_BITS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.PALETTE_SEL_BITS}] ${MODELPARAM_VALUE.PALETTE_SEL_BITS}
}
