...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "INDEX_W" -parent ${Page_0}
...
proc update_PARAM_VALUE.INDEX_W { PARAM_VALUE.INDEX_W } {
	# Procedure called to update INDEX_W when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.INDEX_W { PARAM_VALUE.INDEX_W } {
	# Procedure called to validate INDEX_W
	return true
}
...
proc update_PARAM_VALUE.TILE_H { PARAM_VALUE.TILE_H } {
	# Procedure called to update TILE_H when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.TILE_H { PARAM_VALUE.TILE_H } {
	# Procedure called to validate TILE_H
	return true
}

proc update_PARAM_VALUE.TILE_W { PARAM_VALUE.TILE_W } {
	# Procedure called to update TILE_W when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.TILE_W { PARAM_VALUE.TILE_W } {
	# Procedure called to validate TILE_W
	return true
}
...
proc update_MODELPARAM_VALUE.INDEX_W { MODELPARAM_VALUE.INDEX_W PARAM_VALUE.INDEX_W } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.INDEX_W}] ${MODELPARAM_VALUE.INDEX_W}
}
...
proc update_MODELPARAM_VALUE.TILE_W { MODELPARAM_VALUE.TILE_W PARAM_VALUE.TILE_W } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.TILE_W}] ${MODELPARAM_VALUE.TILE_W}
}

proc update_MODELPARAM_VALUE.TILE_H { MODELPARAM_VALUE.TILE_H PARAM_VALUE.TILE_H } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.TILE_H}] ${MODELPARAM_VALUE.TILE_H}
}
