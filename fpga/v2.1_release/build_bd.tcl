...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.NUM_CORES {23} $tile_scheduler_top_0
  ...
  connect_bd_net -net colour_palette_0_palette_ready [get_bd_pins colour_palette_0/palette_ready] [get_bd_pins perf_counters_0/stream_ready] [get_bd_pins iter_core_array_0/out_ready]
  ...
  connect_bd_net -net iter_core_array_0_out_escaped_to_palette [get_bd_pins iter_core_array_0/out_escaped] [get_bd_pins perf_counters_0/pixel_escaped] [get_bd_pins colour_palette_0/in_escaped]
  connect_bd_net -net iter_core_array_0_out_iter_to_palette [get_bd_pins iter_core_array_0/out_iter] [get_bd_pins perf_counters_0/pixel_iter] [get_bd_pins colour_palette_0/in_iter_count]
  ...
  connect_bd_net -net iter_core_array_0_out_valid_to_palette [get_bd_pins iter_core_array_0/out_valid] [get_bd_pins perf_counters_0/stream_valid] [get_bd_pins colour_palette_0/in_valid]
