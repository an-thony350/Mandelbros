...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net pixel_scheduler_top_0_render_rst_n_out [get_bd_pins pixel_scheduler_top_0/render_rst_n_out] [get_bd_pins iter_core_array_0/rst_n] [get_bd_pins reorder_buffer_0/rst_n] [get_bd_pins colour_palette_0/rst_n] [get_bd_pins packer_0/aresetn] [get_bd_pins perf_counters_0/rst_n]
